...
# m2d.save('./10_phv_eikonal_EA.npz')
# 
# m2d=model2d.model2d(minlon=minlon, maxlon=maxlon, dlon=0.5, minlat=minlat, maxlat=maxlat, dlat=0.5)
...
# m2d2.plot(label='Target phase velocity', vmin=2.8, vmax=3.3, geopolygons=basins)
# 
# diffm2d = m2d1-m2d2
# diffm2d.minlat=minlat; diffm2d.maxlat=maxlat; diffm2d.minlon=minlon; diffm2d.maxlon=maxlon
# # # 
# diffm2d.np2ma()
# diffm2d.plot(label='phase velocity difference',vmin=-0.1, vmax=0.1, showfig=True)
